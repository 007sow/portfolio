  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/85 dark:bg-[#0b1117]/85",
        className
      )}
    >
      {children}
      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-cyan-50 dark:bg-white/10"
            />
          )}
